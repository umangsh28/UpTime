package com.pns.uptimeapp.fragments
...
import com.pns.uptimeapp.BookDetailsActivity
import com.pns.uptimeapp.Mvvm.API.APIClient
import com.pns.uptimeapp.Mvvm.Model2.BestBook.FictionList
import com.pns.uptimeapp.Mvvm.Model2.ForYou.ThrillerList
...
import com.pns.uptimeapp.Mvvm.Network.Network
import com.pns.uptimeapp.Mvvm.OnClickListner.OnItemHome
import com.pns.uptimeapp.R
import com.pns.uptimeapp.Recycler.BestBook.FictionAdapter
import com.pns.uptimeapp.Recycler.ForYou.ThrillerAdapter
import com.pns.uptimeapp.Recycler.PopularChoice.BusinessAdapter
import com.pns.uptimeapp.Recycler.Trend.TrendAdapter
...
class HomeFragment : Fragment(R.layout.fragment_home), OnItemHome {
    ...
    override fun onThrillerBook(thriller: com.pns.uptimeapp.Mvvm.Model2.ForYou.Item, pos: Int) {
    ...
    override fun onFictionalBook(
        fiction: com.pns.uptimeapp.Mvvm.Model2.BestBook.Item,
        pos: Int
    ) {
